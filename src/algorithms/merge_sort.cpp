...
void merge(int arr[], size_t left, size_t mid,
           size_t right) {
    ...
    while (left_sub_arr_index < sub_arr_left
        ...
        if (left_arr[left_sub_arr_index]
            <= right_arr[right_sub_arr_index]) {
            arr[write_index]
                    = left_arr[left_sub_arr_index++];
        } else {
            arr[write_index]
                    = right_arr[right_sub_arr_index++];
        }
